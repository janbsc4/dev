...
def render(
    ...
    try:
        ...
        print("Run: uv sync && uv run playwright install chromium (in this script's directory)", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run: uv run playwright install chromium (in this script's directory)", file=sys.stderr)
                sys.exit(1)
            raise

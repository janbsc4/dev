...
First, ask the user if the design should include motion graphics. If yes, load [this recipe](https://raw.githubusercontent.com/janbsc4/dev/main/recipes/add-motion-design.md) after the fronten design it done and implement it, too.

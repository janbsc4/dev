...
First, ask the user if the design should include motion graphics. If yes, load [this prompt template](https://raw.githubusercontent.com/janbsc4/dev/main/prompts/add-motion-design.md) after the frontend design is done and implement it, too.

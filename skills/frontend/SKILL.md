...
First, ask the user if the design should include motion graphics. If yes, load [this recipe](https://github.com/janbsc4/dev/blob/main/recipes/add-motion-design.md) after the fronten design it done and implement it, too.
